...
TH1F* LW200jet_mass = new TH1F("DiJet_Invmass","Invariant mass from DiJets ",800,0,400);
TH1F* LW200LW_mass = new TH1F("LW_Invmass","Invariant mass from LW",800,0,400);
TH1F* LW200Corrjet_mass = new TH1F("DiCorrJet_Invmass","Invariant mass from corrected DiJets ",800,0,400);
TH1F* LW200Sjet_mass = new TH1F("SDiJet_Invmass","Invariant mass from Signal DiJets ",800,0,400);
TH1F* LW200Genjet_mass = new TH1F("GenDiJet_Invmass","Invariant mass from Gen DiJets ",800,0,400);
TH1F* LW200jet_massfilter = new TH1F("DiJet_Invmass_filter","Events with DiJets invariant mass ",2,0,2);
TH1F* LW200Sjet_massfilter = new TH1F("SDiJet_Invmass_filter","Events with Signal DiJets invariant mass ",2,0,2);
TH1F* LW200Genjet_massfilter = new TH1F("DiGenJet_Invmass_filter","Events with Gen DiJets invariant mass ",2,0,2);
...
void EventLoopAnalysisTemplate::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("GenDau_e",&GenDau_e,&b_GenDau_e);
