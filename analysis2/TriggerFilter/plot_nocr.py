...
colors = {
        "LW400": ROOT.TColor.GetColor("#BF2229"),
...
def main(variable):
    ...
    # Simulation
    LW400 = getHistogram(tfile, "LW400", variable)
...
#    QCD.Scale(QCDScaleFactor)
    ...
    LW400.SetMarkerStyle(20)
    LW400.SetLineColor(colors["LW400"])
    LW200.SetMarkerStyle(20)
    LW200.SetLineColor(colors["LW200"])

    scale_LW400 = 1000000.0
    LW400.Scale(scale_LW400)
    scale_LW200 = 10000.0
    LW200.Scale(scale_LW200)

    #LW200.SetLineWidth(3)

    for x in [LW200, LW400]:
        x.SetLineWidth(3)
...
#    for x in [QCD, TT, W, ZLL]:
    ...
    legend.AddEntry(LW400, "lwe#rightarrowZe (x%.0f)"%scale_LW400, "l")
