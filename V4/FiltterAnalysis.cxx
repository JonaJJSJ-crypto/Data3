...
TH1F* WZGenZdau_pt = new TH1F("WZGenZdau_pt","GensZdau pt for missing trigg",100,0,200);
TH1F* WZGenZdau_eta = new TH1F("WZGenZdau_eta","GensZdau eta for missing trigg",100,-5,5);
...
TH1F* WZGenjet_mass = new TH1F("WZRecoDiEle_Invmass","Invariant mass from Gen DiJets ",800,0,400);
...
EventLoopAnalysisTemplate::EventLoopAnalysisTemplate(TString thefile, TString thelabel, Float_t sampleweight) : fChain(0)
{
  ...
  hists[12]=WZGenZdau_pt;
  hists[13]=WZGenZdau_eta;
