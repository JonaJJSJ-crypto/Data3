...
TH1F* LW200Genelec_disp = new TH1F("Generated_electron_Bmatch","Gen Electron secondary vertex displacement",200,0,1);
TH1F* LW200EleBsecvec = new TH1F("Electron_Bmatch","Best matched secondary vertex displacement",200,0,1);
TH1F* LW200Genelec_disp_f = new TH1F("Generated_electron_Bmatch Filtered","Gen Electron secondary vertex displacement filtered",200,0,1);
TH1F* LW200EleBsecvec_f = new TH1F("Electron_Bmatch_Filtered","Best matched secondary vertex displacement filtered",200,0,1);
TH1F* LW200TrigObj = new TH1F("TriggerObject_Electrons","Number of electrons and trigger Object matching",2,0,2);
TH1F* LW200TrigObjDR = new TH1F("TriggerObject_Electrons_DR","Number of electrons and trigger Object matching deltaR",200,0,4);
